  ...
  <div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('tambah_jabatan_keuangan') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <label for="customername-field" class="form-label">Nama Jabatan</label>
                        <select class="form-select mb-3" aria-label="Default select example" name="jabatan">
                            <option selected disabled>Nama Jabatan</option>
